...
const FEATURES: Feature[] = [
    {
        ...
        titleSizeClass: 'text-[38px] md:text-[50px] lg:text-[64px] xl:text-[68px]',
        descSizeClass: 'text-[18px] md:text-[22px] lg:text-[24px]',
    ...
    },
    {
        ...
        titleSizeClass: 'text-[36px] md:text-[48px] lg:text-[60px]',
        descSizeClass: 'text-[18px] md:text-[20px] lg:text-[22px]',
    },
    {
        ...
        <div className="w-full flex flex-col items-center py-16 md:py-24 gap-10 md:gap-16">
            {featuresToRender.map((feature) => (
                <div
                    ...
                    className={`w-[94%] lg:w-[90%] max-w-[1500px] mx-auto flex flex-col items-center justify-between gap-12 md:gap-24 ${feature.imageRight ? 'md:flex-row-reverse' : 'md:flex-row'
                        }`}
                >
                    {/* Rive Animation */}

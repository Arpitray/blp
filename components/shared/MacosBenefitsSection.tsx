...
const BENEFITS = [
    ...
    },
    {
        ...
        content: "BlockP is your greatest ally in quitting porn. It blocks your triggers to prevent relapse on unlimited devices. Accountability and porn-blocking features of BlockP help you stay porn-free in the long term."
    },
    {
        title: "Improve Productivity",
        content: "BlockP helps to remove distractions like porn, social media, and gambling sites. Intentional and focused use boosts your productivity at work and in studies."
    },
]

export function MacosBenefitsSection({ data }: { data?: { sectionTitle?: string; items?: { title?: string; iconPath?: string; description?: string }[] } }) {
    const title = data?.sectionTitle || "Benefits of Using BlockP Porn Blocker for MacBook"

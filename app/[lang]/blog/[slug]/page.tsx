    ...
    return (
        <>
            <div className="w-full flex flex-col items-center bg-[#F6FAFF] mb-[120px]">
                ...
                {/* ── Main Body ── */}
                <article className="w-full px-[24px] lg:px-[40px] max-w-site mt-24 flex flex-col lg:flex-row lg:justify-between gap-[60px] lg:gap-[80px]">
                ...
                {relatedPosts.length > 0 && (
                    <div className="w-full max-w-site px-[24px] lg:px-[40px] mt-32 mb-12 flex flex-col items-center">
